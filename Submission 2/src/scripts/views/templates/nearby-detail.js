  ...
  <div class="detail">
    ...
    <div tabindex="0" class="form-review">
      <div class="card-form-detail">
        <img tabindex="0" class="detail-img" src="/images/logo/review-logo.jpg" alt="Gambar background untuk review">
      </div>
      ...
      <div class="card-form-detail">  
        <form tabindex="0" autocomplete="on">
          <div class="input-form-review">
            ...
            <input tabindex="0" type="text" class="form-control" id="name-input" minlength="1" maxlength="15" placeholder="Masukkan nama Anda" required>
          </div>

          <div class="input-form-review">
            <label tabindex="0" for="review-input" class="form-label">Review:</label>
            <input tabindex="0" type="text" class="form-control" id="review-input" minlength="1" maxlength="15" placeholder="Masukkan review Anda" required>
          </div>
    ...
    ${dataResto.customerReviews
      .map(
        (dataReview) => `
          ...
          <img tabindex="0" src="/images/logo/user-logo.png" alt="Gambar user review">
